...
public class PowerMeasureTypeDao {
    ...
    public List<PowerMeasureType> getAllByUser(LoginUser user) {
    ...
    public List<PowerMeasureType> getEnabledByUser(LoginUser user) {
	TypedQuery<PowerMeasureType> lQuery = em.createQuery(
    ...
    public List<PowerMeasureType> createDefaults(LoginUser user) {
